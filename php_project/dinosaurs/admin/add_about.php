        ...
        <div class="row g-0">
            <div class="col pe-lg-2 mb-3">
                <div class="card h-lg-100 overflow-hidden">
                    <div class="card-body">
                        <h3>Add new About Page</h3>
                        <form action="insert_about.php" method="post" enctype="multipart/form-data">
                            <div class="mb-3"><label class="form-label" for="basic-form-name">Header</label><input class="form-control" id="basic-form-name" type="text" placeholder="Add new header" name="about_header"/></div>

                            <div class="mb-3"><label class="form-label">Upload Image</label><input class="form-control" type="file" name="about_image"/></div>
