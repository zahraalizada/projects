                                        ...
                                        while ($row = $query->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            echo "
                                                    <tr>
                                                        ...
                                                        <td class='text-end'>
                                                            <div>
                                                                <a href='edit_post.php?p_id=" . $row['id'] . "' class='btn p-0' data-bs-toggle='tooltip'
                                                                        data-bs-placement='top' title='Edit'><span
                                                                            class='text-500 fas fa-edit'></span></a>
                                                                <a onclick='return confirm(\"Are you sure? \");' href='delete_post.php?p_id=" . $row['id'] . "' class='btn p-0 ms-2' data-bs-toggle='tooltip'
