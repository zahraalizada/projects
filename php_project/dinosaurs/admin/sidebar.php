            ...
            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                <li class="nav-item">
                    ...
                    <ul class="nav collapse show" id="dashboard">
                        ...
                        <li class="nav-item"><a class="nav-link" href="contact.php" aria-expanded="false">
                                <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Contact</span></div>
                            </a>
                        </li>
                        <li class="nav-item"><a class="nav-link  " href="team.php" aria-expanded="false">
